document.addEventListener("DOMContentLoaded", function () {
    ...
    heading.textContent = "Даратерия правила";
    ...
    function createSection(id, title, content) {
        ...
        button.addEventListener("click", () => toggleContent(id));
    ...
    createSection(
        ...
        "Общие положения",
        `
        <p>1.1. Незнание правил не освобождает игрока от ответственности. Вследствие нарушения правил сервера, аккаунт будет наказан, вне зависимости от того, какое именно лицо совершило нарушение.</p>
    ...
    linkButton.href = "https://darateria.com";
